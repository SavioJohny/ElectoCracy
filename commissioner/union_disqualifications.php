...
$page_title = 'Union Election Disqualifications';
...
// Get all union-eligible students (approved candidates in class elections)
$stmt = $pdo->prepare("
    SELECT DISTINCT u.user_id, u.fname, u.lname, u.roll_number, u.email, u.gender,
    ...
    ORDER BY c.class_name, u.roll_number, u.fname, u.lname
");
$stmt->execute([$union_election['election_year']]);
$union_eligible_students = $stmt->fetchAll();
...
$voting_status = $union_election['voting_status'];
$can_modify = in_array($voting_status, ['not_started', 'active']);
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h2><i class="fas fa-university me-2"></i>Union Election Disqualifications - <?php echo $union_election['election_year']; ?></h2>
                    <p class="text-muted">Manage student disqualifications for union election</p>
                </div>
                <div>
        ...
        <div class="row mb-4">
            <div class="col-12">
                <div class="alert alert-warning">
                    ...
                    Students can only be disqualified or requalified when the voting status is "Not Started" or "Active".
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">
                            <i class="fas fa-users me-2"></i>Union-Eligible Students
                        </h5>
                        <div>
                ...
                <div class="card-body">
                    <?php if (empty($union_eligible_students)): ?>
                        <div class="alert alert-info">
                            <i class="fas fa-info-circle me-2"></i>
                            No union-eligible students found. Students must be approved candidates in class elections to be eligible for union elections.
                        </div>
                    <?php else: ?>
                        <div class="table-responsive">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <?php foreach ($union_eligible_students as $student): ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('.disqualify-btn').forEach(button => {
        button.addEventListener('click', function() {
            ...
            if (confirm(`Are you sure you want to disqualify ${studentName} from the union election?\n\nThis will prevent them from voting in the union election.`)) {
    ...
    document.querySelectorAll('.requalify-btn').forEach(button => {
        button.addEventListener('click', function() {
            ...
            if (confirm(`Are you sure you want to requalify ${studentName} for the union election?\n\nThis will allow them to vote in the union election again.`)) {
...
function handleDisqualification(action, studentId, electionId, studentName) {
    ...
    fetch('union_disqualification_handler.php', {
        method: 'POST',
        body: formData
    })
