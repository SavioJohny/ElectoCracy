                    ...
                    <?php else: ?>
                        <div class="table-responsive">
                            <table class="table table-hover" id="classElectionsTable">
                                <thead>
                                    <tr>
                                        <th><a href="#" onclick="sortClassTable('class'); return false;" class="text-decoration-none text-dark">Class <i class="fas fa-sort ms-1"></i></a></th>
                                        <th><a href="#" onclick="sortClassTable('department'); return false;" class="text-decoration-none text-dark">Department <i class="fas fa-sort ms-1"></i></a></th>
                                        <th><a href="#" onclick="sortClassTable('status'); return false;" class="text-decoration-none text-dark">Status <i class="fas fa-sort ms-1"></i></a></th>
                                        <th><a href="#" onclick="sortClassTable('results'); return false;" class="text-decoration-none text-dark">Results Status <i class="fas fa-sort ms-1"></i></a></th>
                                        <th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php foreach ($class_elections as $election): ?>
                                        <tr data-department="<?php echo htmlspecialchars($election['department_name']); ?>">
                                            ...
                                            <td data-sort="<?php echo $election['voting_status']; ?>">
                                                <span class="badge bg-<?php echo $election['voting_status'] === 'ended' ? 'success' : ($election['voting_status'] === 'active' ? 'primary' : 'secondary'); ?>">
                                                    <?php echo ucfirst(str_replace('_', ' ', $election['voting_status'])); ?>
                                                </span>
                                            </td>
                                            <td data-sort="<?php echo $election['results_published'] ? '1' : '0'; ?>">
                                                <span class="badge bg-<?php echo $election['results_published'] ? 'success' : 'secondary'; ?>">
                                                    <?php echo $election['results_published'] ? 'Published' : 'Hidden'; ?>
                                                </span>
                                            </td>
                                            <td>
                                                <div class="btn-group btn-group-sm">
                                                    <?php if ($election['voting_status'] === 'ended'): ?>
                                                        <a href="class_results.php?election_id=<?php echo $election['election_id']; ?>" class="btn btn-outline-primary">View Results</a>
                                                        <button class="btn btn-outline-<?php echo $election['results_published'] ? 'warning' : 'success'; ?>" onclick="toggleClassResults(<?php echo $election['election_id']; ?>, <?php echo $election['results_published'] ? 'false' : 'true'; ?>)">
                                                            <?php echo $election['results_published'] ? 'Hide Results' : 'Publish Results'; ?>
                                                        </button>
                                                    <?php else: ?>
                                                        <button class="btn btn-outline-secondary" disabled>Voting Not Ended</button>
                                                    <?php endif; ?>
                                                </div>
                                            </td>
                                        </tr>
